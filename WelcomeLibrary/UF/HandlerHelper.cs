...
namespace WelcomeLibrary.UF
{
    public static class HandlerHelper
    {
        ...
        public static Dictionary<string, string> GetParamsAMPSeparator(string Body)
        {
            Dictionary<string, string> ret = new Dictionary<string, string>();
            if (!string.IsNullOrEmpty(Body))
            {
        ...
        public static Dictionary<string, string> getHandlerParameters(HttpContext context)
        {
        ...
        public static Dictionary<string, string> GetParamsJSON(string Body)
        {
            Dictionary<string, string> ret = new Dictionary<string, string>();
            if (!string.IsNullOrEmpty(Body))
                try
                {
                    Dictionary<string, string> tmp = Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, string>>(Body);
                    foreach (var kv in tmp)
                    {
                        ret.Add(kv.Key.ToLower(), kv.Value);
                    }
                }
                catch { }
            return ret;
        ...
        public static Dictionary<string, string> GetParamsByRowPipe(string Body)
        {
            Dictionary<string, string> ret = new Dictionary<string, string>();
            if (!string.IsNullOrEmpty(Body))
            {
