...
#region CARICAMENTO DELLE TABELLE DI RIFERIMENTO PER LE CARATTERISTICHE!!
        ...
        public static TabrifCollection CaricaListaStaticaCaratteristica(string connection, string tablename)
        {
            ...
            try
            {
                ...
                OleDbDataReader reader = dbDataAccess.GetReaderOle(query, null, connection);
                using (reader)
                {
...
ZW	Zimbabwe
        ...
        public static bool CaricaListaStaticaComuni(string connection, string codiceprovincia)
        {
            ...
            try
            {
                ...
                OleDbParameter p1 = new OleDbParameter("@codiceprovincia", codiceprovincia);//OleDbType.VarChar
                parColl.Add(p1);
        ...
        public static bool CaricaListaStaticaTipologieContenuti(string connection, string Lingua)
        {
            ...
            try
            {
                ...
                List<OleDbParameter> parColl = new List<OleDbParameter>();
                OleDbParameter p1 = new OleDbParameter("@Lingua", Lingua);//OleDbType.VarChar
                parColl.Add(p1);
                OleDbDataReader reader = dbDataAccess.GetReaderListOle(query, parColl, connection);
                using (reader)
                {
        ...
        public static bool CaricaListaStaticaProdottoPerCodice(string connection, string codiceattivita)
        {
            ...
            try
            {
                ...
                List<OleDbParameter> parColl = new List<OleDbParameter>();
                OleDbParameter p1 = new OleDbParameter("@codiceattivita", codiceattivita);//OleDbType.VarChar
                parColl.Add(p1);
                OleDbDataReader reader = dbDataAccess.GetReaderListOle(query, parColl, connection);
