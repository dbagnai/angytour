        ...
        try
        {
            ...
            if (clientimail != null)
            {
                ...
                foreach (Cliente c in clientimail)
                {
                    ...
                    mail.SoggettoMail = GetGlobalResourceObject("Common", "oggettoMailInserimentoOfferta").ToString();
                    mail.TestoMail = GetGlobalResourceObject("Common", "testoMailInserimentoOfferta").ToString() + "<br/>";
                    ...
                    mail.TestoMail += "<a href=\"" + link + "\" target=\"_blank\" style=\"font-size:22px;color:#b13c4e\">" + GetGlobalResourceObject("Common", "TestoLinkAOfferta").ToString() + "<br/>";
