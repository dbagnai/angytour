<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GestioneNewsletter.aspx.cs"
    Inherits="AreaContenuti_GestioneNewsletter" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" ValidateRequest="false" %>
...
<body style="width: 1000px; margin: 0 auto; border: 2px Solid #ccc; background-color: #ccc">
    <div style="background-color: White; padding: 20px">
        ...
        <form id="form1" runat="server">
            <Ajax:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" AllowCustomErrorsRedirect="True"
                ...
                <Scripts>
                    <asp:ScriptReference Path="~/Scripts/jquery-1.10.1.min.js" NotifyScriptLoaded="true" />
                    ...
                    <asp:ScriptReference Path="~/Scripts/tinymce/tinymce.min.js" />
                    <%--<asp:ScriptReference Path="//tinymce.cachefly.net/4.0/tinymce.min.js" />--%>
                </Scripts>
            </Ajax:ToolkitScriptManager>

            <h1>CREAZIONE NEWSLETTER</h1>
            ...
            <br />
            <a href="Default.aspx" style="font-size: 15px">Torna a pagina di selezione</a><br />
