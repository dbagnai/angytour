<%@ Page Title="" Language="C#" MasterPageFile="~/AreaContenuti/MasterPage.master" AutoEventWireup="true" CodeFile="GestioneBookingListini.aspx.cs" Inherits="AreaContenuti_GestionebookingListini" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" src="<%= CommonPage.ReplaceCdnLinks("~/lib/js/bookinglistini.js" ) + CommonPage.AppendModTime(Server,"~/lib/js/bookinglistini.js") %>"></script>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="pull-left">
                    <label>Selezione Tipo Listino</label>
                    <select id="ddl1tipofasce" class="form-control searchlist" style="width: auto" onchange="reloadbytipo(this)">
                    </select>
