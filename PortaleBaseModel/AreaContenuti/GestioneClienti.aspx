<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GestioneClienti.aspx.cs"
    Inherits="AreaContenuti_GestioneClienti" ValidateRequest="false" %>
    ...
    <div style="background-color: White; padding: 20px; min-height: 1800px;position:relative;">
        <form id="form1" runat="server">
            <Ajax:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
                <Scripts>
                    <asp:ScriptReference Path="~/Scripts/jquery-1.9.1.min.js" NotifyScriptLoaded="true" />
                    <asp:ScriptReference Path="~/Scripts/jquery-migrate-1.1.1.min.js" NotifyScriptLoaded="true" />
                    <asp:ScriptReference NotifyScriptLoaded="true" Path="~/Scripts/jquery.cycle.all.js" />
                    <asp:ScriptReference Path="~/Scripts/jquery.tools.min.js" NotifyScriptLoaded="true" />
                </Scripts>
            </Ajax:ToolkitScriptManager>
            <h1>GESTIONE ANAGRAFICHE CLIENTI</h1>
            ...
            <br />
            <br />
            <a href="Default.aspx" style="font-size: 15px">TORNA A PAGINA PRINCIPALE</a><br />
            <br />
            <br />
            <br />
