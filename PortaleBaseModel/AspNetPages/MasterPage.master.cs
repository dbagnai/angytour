...
public partial class AspNetPages_MasterPage : System.Web.UI.MasterPage
{
    ...
    private void ControllaHttp()
    {
        ...
        else
        {
            ...
            {
                Response.Redirect(System.Web.HttpContext.Current.Request.Url.ToString().Replace("https:", "http:"));
            }
        }
    }
    ...
    public void VisualizzaTotaliCarrello()
    {
        ...
        litTotalHigh.Text = String.Format(System.Globalization.CultureInfo.CreateSpecificCulture("it-IT"), "{0:N2}", totalecarrello) + " €";
    }
    #endregion
}
