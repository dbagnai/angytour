                    ...
                    <div class="row">
                        ...
                        <asp:PlaceHolder runat="server" ID="plhForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <asp:CheckBox ID="chkPrivacy" runat="server" Checked="true" Text='<%# references.ResMan("Common", Lingua,"testoPrivacy") %>' />
                                    ...
                                    <br />
                                    <asp:CheckBox ID="chkConsensoMail" runat="server" Checked="true" Text='<%# references.ResMan("Common", Lingua,"testoConsenso1") %>' />
                                    <br />
