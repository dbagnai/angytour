            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="widget shop-selections">
                        <h3>
                            <%= references.ResMan("Common", Lingua,"CarrelloSelezioneArticoli") %></h3>
                    ...
                    <div class="widget bill-payment">
                        ...
                        <%= references.ResMan("Common", Lingua,"txtEstero") %>
                        <script> 
                        ...
                        <ul class="unstyled">
                            <li style="display: block">
                                <div class="clearfix" style="margin-bottom: 20px">
                                    <input type="radio" class="form-control" style="padding: 3px; width: 50px; background-color: transparent" disabled="false" checked="true" name="payment_method" value="contanti" onclick="refreshcarrello(this, 'inpContanti')"
                                        runat="server" id="inpContanti" />

                                    <b><%= references.ResMan("Common", Lingua,"txtcontanti") %>
                                    </b>
                                    <br />
                            ...
                            <li style="display: block">
                                <div class="clearfix" style="margin-bottom: 20px">
                                    <input type="radio" class="form-control" style="padding: 3px; width: 50px; background-color: transparent" name="payment_method" value="bacs" checked="false" onclick="refreshcarrello(this, 'inpBonifico')" autopostback="true" runat="server" id="inpBonifico" />
                            ...
                            <li style="display: none">
                                <div class="clearfix" style="margin-bottom: 20px">
                                    <input type="radio" class="form-control" style="padding: 3px; width: 50px; background-color: transparent" value="payway" runat="server" id="inpPayway" autopostback="true" />
                            ...
                            <li style="display: block">
                                <div class="clearfix" style="margin-bottom: 20px">
                                    <input type="radio" class="form-control" style="padding: 3px; width: 50px; background-color: transparent" disabled="false" checked="false" name="payment_method" value="paypal" runat="server" autopostback="true" id="inpPaypal" onclick="refreshcarrello(this, 'inpPaypal')" />
