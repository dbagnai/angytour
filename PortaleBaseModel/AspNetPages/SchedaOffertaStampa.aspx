<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchedaOffertaStampa.aspx.cs" EnableViewState="false"
...
<body style="background: none; width: 880px; font-family: Raleway; border: 1px solid #ccc;">
    ...
    <form id="formcontenuti" runat="server">
       ...
       <div style="width: auto; height: 100px; padding-top: 30px; padding-bottom: 30px; margin-bottom: 10px; text-align: center; background: url(../images/SiteSpecific/sfondohead.jpg) repeat-x top left">
            <img src='<%=CommonPage.ReplaceAbsoluteLinks("~/images/main_logo_footer.png")%>'
                style="height: 100%;" alt="<%= WelcomeLibrary.UF.ConfigManagement.ReadKey("Nome") %>" />
        </div>
