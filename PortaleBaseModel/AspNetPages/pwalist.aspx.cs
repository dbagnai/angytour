...
public partial class AspNetPages_pwalist : CommonPage
{
    ...
    private void ModificaFiltroJS()
    {
        ...
        if (prevtipologia != Tipologia) //Se cambio tipologia svuoto la memoria di filtro in sessione
        {
...
#if true //Gestione modificatori filtro categoria li setto solo per la categoria che è interessata ( c'è un problema di non suotamento con tools iniettatti in pagine non lista se la tipologia non cambia nella navigazione !! !!!)
