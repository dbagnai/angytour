...
public partial class AspNetPages_Orderpage : CommonPage
{
    ...
    protected void btnCodiceSconto_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            lblCodiceSconto.Text = GetGlobalResourceObject("Common", "testoErrCodiceSconto").ToString();
        }
        CaricaCarrello();
    }
    ...
    private void VerificaStatoLoginUtente()
    {
        ...
        {
            Session.Add("Errororder", GetGlobalResourceObject("Common", "testoRichiestalogin").ToString());
            Response.Redirect(GetGlobalResourceObject("Common", "linkLogin").ToString());
        }
    }
    ...
    private void AggiornaDatiUtenteSuCarrello(CarrelloCollection carrello, int idcliente = 0)
    {
        foreach (Carrello c in carrello)
        {
            ...
            AggiornaProdottoCarrello(Request, Session, c.id_prodotto, c.Numero, User.Identity.Name, idcliente);
        }
    }
        ...
        try
        {
            ...
            if (prodotti != null && prodotti.Count > 0)
            {
                ...
                if (inpBonifico.Checked)
                {
                    ...
                    descrizionepagamento = GetGlobalResourceObject("Common", "chk" + modalita).ToString();  //_> da inserie la descrizione della forma di pagamento
                }
                ...
                {
                    output.Text = GetGlobalResourceObject("Common", "txtPagamento").ToString();
                    return;
                }
    ...
    private void MemorizzaDatiPerPaypal(double percentualeanticipo, TotaliCarrello totali, CarrelloCollection prodotti, ref Dictionary<string, List<string>> paypaldatas)
    {
        ...
        foreach (Carrello p in prodotti)
        {
            ...
            if (p.Offerta != null)
            {
                dettagliitem.Add(p.Offerta.DenominazioneI);//Prendo il valore I per ora senza modificare x lingua
            }
    ...
    protected void EseguiCheckOutPaypal(string returnurl, string cancelurl, Dictionary<string, List<string>> paypaldatas, bool authandcapture)
    {
        ...
        if (paypaldatas != null && paypaldatas.Count > 0)
        {
            ...
            else
            {
                ...
                output.Text = GetGlobalResourceObject("Common", "risposta_4").ToString() + " Error" + errcode + "<br/>";
                output.Text += desc + "<br/>";
        ...
        else
        {
            ...
            output.Text = GetGlobalResourceObject("Common", "risposta_4").ToString() + "  Assente importo operazione.<br/>";
        }
    }
    ...
    protected string CreaMailPerFornitore(TotaliCarrello totali, CarrelloCollection prodotti)
    {
        ...
        TestoMail += "<table cellpadding='0' cellspacing='0'  style='font-family:Calibri; font-size:14px;'><tr><td> Ordine effettuato da " + totali.Denominazionecliente + " tramite sito " + Nome + "  <br/>";
        ...
        TestoMail += totali.Indirizzospedizione + "<br/></td></tr>";
        TestoMail += "<tr><td> <br/>Note : " + totali.Note + "<br/></td></tr>";

        TestoMail += "<tr><td><table cellpadding='0' cellspacing='0' style='font-family:Calibri; font-size:14px;'><tr><td><br/> DETTAGLIO ORDINE : <br/></td></tr>";
        ...
        if (totali.TotaleSpedizione != 0)
            TestoMail += "<tr><td><br/>SPESE DI SPEDIZIONE " + totali.TotaleSpedizione + "  €";
    ...
    protected string CreaMailCliente(TotaliCarrello totali, CarrelloCollection prodotti)
    {
        ...
        TestoMail += "<tr><td><table cellpadding='0' cellspacing='0'><tr><td style='font-family:Calibri; font-size:14px; color:#e12222;'> <br/>Dettagli prodotti : </td></tr>";
        TestoMail += "<tr><td style='font-family:Calibri; font-size:14px; color:#252626;'> <br/>CODICE ORDINE : " + totali.CodiceOrdine + "<br/></td></tr>";
        int i = 1;
        foreach (Carrello item in prodotti)
        {
            TestoMail += "<tr><td style='font-family:Calibri; font-size:14px; color:#252626;'>" + "<font color='#e12222'>" + i.ToString() + "</font> - ";
            switch (Lingua)
            {
                case "GB":
